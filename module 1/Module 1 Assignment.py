...
## This code shows the confidentiality part of the CIA triad. Only users with the correct role can access certain actions, and anyone without the right permissions gets denied. 
