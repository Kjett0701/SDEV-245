    ...
    for char in message: 
        if char.isalpha():
            ...
            if char.isupper():
                ...
                # If the characters (letters) are uppercase, apply the shift using the ASCII range for lowercase letters. 
            else:
...
# If the user chose the "decrypt" option, the program will start with a blank decrypted message to build off of. 
    ...
    for char in message: 
        if char.isalpha():
            ...
            # If the characters (letters) are uppercase, reverse the shift using the ASCII range for lowercase letters.  
            else:
